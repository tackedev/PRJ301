 ...
 * @author tackedev
 */
@WebServlet(name = "OnlineShoppingServlet", urlPatterns = {"/OnlineShoppingServlet"})
public class OnlineShoppingServlet extends HttpServlet {
    
    private final String ONLINE_SHOPPING_PAGE = "onlineShopping.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ONLINE_SHOPPING_PAGE;
        
        try {
            // Call DAO then get ProductList
