...
public class SessionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2>Information on Session:</h2>");
            out.println("<table border=1 align=\"center\">");
            out.println("   <tr bgcolor=\"#FFAD00\">");
            out.println("       <th>Info Type<th>Value");
            out.println("   <tr>");
            out.println("       <td>ID");
            out.println("       <td>" + session.getId());
            out.println("   <tr>");
            out.println("       <td>Create time");
            ...
            out.println("   <tr>");
            out.println("       <td>Number of Previous Accesses");
            out.println("       <td>" + accessCount);
            out.println("   <tr>");
            out.println("       <td>Session Time out");
